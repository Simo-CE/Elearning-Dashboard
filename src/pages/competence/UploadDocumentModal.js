...
import { deleteAsset, fileiconAsset, identityAsset, tickAsset, uploadAsset, uploaddocAsset } from "../../assets";
    ...
    return (
        <>
            ...
            >
                        ...
                        <div className="col-lg-12 mt-3 mb-4">
                            <div className="d-flex">
                                ...
                                <div className="ml-auto d-flex align-items-center" style={{ gap: "10px" }}>
                                    ...
                                    <img src={deleteAsset} alt="" width="20px" height="20px" className="pointer" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <Modal.Footer>
                    <Button label="Cancel" buttonStyle="cancel mr-2" onClick={props.uploadDocumentModalHandler} />
