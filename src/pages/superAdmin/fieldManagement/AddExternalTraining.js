      ...
      <div className="ms-4 me-4">
        <div className="row mt-4">
          <div className="col-lg-8">
            <div>
              <p className="fs-13 fw-550 black">Add External Training Form</p>
              <p className="fs-11 fw-550 gray">
                Manage the available fields of add external training form
              </p>
            </div>
          </div>
...
export default AddExternalTraining;
